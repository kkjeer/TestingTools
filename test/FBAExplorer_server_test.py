...
from FBAExplorer.FBAExplorerImpl import FBAExplorer
from FBAExplorer.FBAExplorerServer import MethodContext
from FBAExplorer.authclient import KBaseAuth as _KBaseAuth

from installed_clients.AssemblyUtilClient import AssemblyUtil
from installed_clients.WorkspaceClient import Workspace


class FBAExplorerTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('FBAExplorer'):
        ...
        cls.serviceImpl = FBAExplorer(cls.cfg)
    ...
    # NOTE: According to Python unittest naming rules test method names should start from 'test'. # noqa
    def test_run_FBAExplorer_ok(self):
        # call your implementation
        ret = self.serviceImpl.run_FBAExplorer(self.ctx,
    ...
    def test_run_FBAExplorer_min_len_negative(self):
        with self.assertRaisesRegex(ValueError, 'min_length parameter cannot be negative'):
            self.serviceImpl.run_FBAExplorer(self.ctx,
                                              {'workspace_name': self.wsName,
                                               'assembly_input_ref': '1/fake/3',
                                               'min_length': '-10'})

    def test_run_FBAExplorer_min_len_parse(self):
